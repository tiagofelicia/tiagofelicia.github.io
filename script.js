...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function parseCSV(csv) {
        // ... (todo o seu código para o gráfico continua aqui, sem alterações)
...
function carregarTabelaCSV(dia, tarifario, opcao) {
    ...
    function init() {
        // Verifica se os elementos da página de preços horários existem antes de correr a lógica
        if (document.getElementById("dropdownDia")) {
        ...
        // Verifica se os elementos da página OMIE/OMIP existem
        if (document.getElementById("tabela-omie")) {
            fetchAndProcessOMIE_OMIP();
        }
    }
